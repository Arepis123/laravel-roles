    ...
    @if($stats['last_scan'])
        <flux:card class="p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                    <div class="font-medium text-gray-600">Last Scan</div>
                    <div class="text-gray-900">{{ $stats['last_scan']->diffForHumans() }}</div>
                </div>
                <div>
                ...
                <div>
                    <div class="font-medium text-gray-600">QR Regenerations</div>
                    <div class="text-gray-900">{{ $stats['generation_count'] ?? 0 }} times</div>
                </div>
            </div>
        </flux:card>
    @endif
