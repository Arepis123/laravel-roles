                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @if($asset_type === 'vehicle' && $booking->asset && $booking->asset->plate_number)
                            <flux:field>
                                ...
                                <flux:input value="{{ $booking->asset->plate_number }}" type="text" readonly/>
                            </flux:field>
                        @endif
                        ...
                        @if($asset_type === 'it_asset' && $booking->asset && $booking->asset->asset_tag)
                            <flux:field>
                                ...
                                <flux:input value="{{ $booking->asset->asset_tag }}" type="text" readonly/>
                            </flux:field>
                        @endif
                    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="border rounded-lg overflow-hidden">               
                ...
                <div class="space-y-3 p-6">
                    <flux:button href="{{ route('bookings.index.admin', ['page' => $returnPage, 'highlightId' => $booking->id]) }}" class="w-full" icon="chevron-left">
                        Back to Bookings
                    </flux:button>

                    @if(auth()->user()->hasRole(['Super Admin']))
                        <flux:button href="{{ route('bookings.edit', ['booking' => $booking->id, 'page' => $returnPage]) }}" class="w-full" icon="pencil-square">
                            Edit Booking
                        </flux:button>
                    @endif
