                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">                                        
                                        <flux:avatar circle color="auto" name="{{ $user->name ? preg_replace('/\s+(BIN|BINTI|BT)\b.*/i', '', $user->name) : 'N/A' }}" />
                                    </div>
                                    <div class="ml-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center gap-1">
                                    @can('user.view')
                                        <flux:button size="sm" variant="ghost" href="{{ route('users.show', ['id' => $user->id, 'page' => $users->currentPage()]) }}" title="View">
                                    ...
                                    @can('user.edit')
                                        <flux:button size="sm" variant="ghost" href="{{ route('users.edit', ['id' => $user->id, 'page' => $users->currentPage()]) }}" title="Edit">
                                            <svg class="size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-lg p-4 shadow-sm">
                ...
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-3 min-w-0 flex-1">
                        <flux:avatar circle size="sm" color="auto" name="{{ $user->name ? preg_replace('/\s+(BIN|BINTI|BT)\b.*/i', '', $user->name) : 'N/A' }}" />
                    ...
                    <flux:dropdown>
                        ...
                        <flux:menu>
                            @can('user.view')
                            <flux:menu.item href="{{ route('users.show', ['id' => $user->id, 'page' => $users->currentPage()]) }}" icon="eye">
                                View Details
                            </flux:menu.item>
                            @endcan
                            @can('user.edit')
                            <flux:menu.item href="{{ route('users.edit', ['id' => $user->id, 'page' => $users->currentPage()]) }}" icon="pencil">
                                Edit User
                            </flux:menu.item>
                            @endcan
                            <flux:menu.separator />
