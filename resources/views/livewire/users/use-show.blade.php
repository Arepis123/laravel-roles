<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="mt-1 sm:mt-2 text-gray-600 dark:text-gray-400 text-sm">Detailed information about {{ $user->name }}</p>
            </div>
    ...
    @endphp         
    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-700 mb-6 sm:mb-8">
        <div class="relative">
            <!-- Background Pattern -->
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-end gap-4 sm:gap-6 pt-8 sm:pt-16">
                    ...
                    <div class="flex-1 text-center sm:text-left sm:pb-2 min-w-0">
                        ...
                        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-3">                            
                            <flux:badge size="" icon="briefcase">
                                {{ $user->position }}
                            </flux:badge>
                            @if($user->roles->first())
                                <flux:badge size="">
                    ...
                    <div class="flex sm:hidden w-full justify-center gap-6 pt-4 border-t border-gray-200 dark:border-zinc-700">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div class="xl:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-700">
                <div class="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200 dark:border-zinc-700">
                        ...
                        <div>
                            <flux:field>
                                ...
                                <div class="mt-1 p-2 sm:p-3 bg-gray-50 dark:bg-neutral-700 rounded-lg">
                                    <span class="text-gray-900 dark:text-white font-medium text-sm">{{ $user->name }}</span>
                                </div>
                            </flux:field>
                        </div>
                        <div>
                            <flux:field>
                                ...
                                <div class="mt-1 p-2 sm:p-3 bg-gray-50 dark:bg-neutral-700 rounded-lg">
                                    <span class="text-gray-900 dark:text-white font-medium text-sm break-all">{{ $user->email }}</span>
                                </div>
                            </flux:field>
                        </div>
                        <div>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-700">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <div class="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-zinc-700">
                    ...
                    @else
                    <div class="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-zinc-700 text-center">
