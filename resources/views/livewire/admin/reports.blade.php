<div>
    ...
    <div class="border border-gray-200 rounded-lg p-6 space-y-6 mb-6">
        ...
        <div class="border-t pt-4">
            ...
            @if($showFilters)
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                    <!-- Date Range -->
                    <flux:field>
    ...
    <div class="border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div class="overflow-hidden">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" wire:click="sortBy('report_type')">
                            ...
                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" wire:click="sortBy('report_format')">
                                <div class="flex items-center space-x-1">
                                    <span>Format</span>
                            ...
                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" wire:click="sortBy('record_count')">
                                <div class="flex items-center space-x-1">
                                    <span>Records</span>
                            ...
                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" wire:click="sortBy('generated_by')">
                                <div class="flex items-center space-x-1">
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" wire:click="sortBy('generated_at')">
                                <div class="flex items-center space-x-1">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <flux:tooltip content="Download">
                                            <flux:button size="sm" wire:click="downloadReport({{ $report->id }})" variant="ghost">
                                                <flux:icon name="document-arrow-down" class="w-4 h-4"/>
                                            </flux:button>                                        
                                        </flux:tooltip>
